...
- [Initial tasks](#initial-tasks)
	- [Create user, add to sudo group](#create-user-add-to-sudo-group)
	- [SSH server](#ssh-server)
	- [Network](#network)
	- [Hostname](#hostname)
	- [Logrotate / rsyslog](#logrotate--rsyslog)
	- [Cron](#cron)
	- [Software firewall (Uncomplicated firewall)](#software-firewall-uncomplicated-firewall)
	- [Remove AppArmor](#remove-apparmor)
- [Nginx](#nginx)
